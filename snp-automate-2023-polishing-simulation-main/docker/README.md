> **交接说明：** 以下是上游项目原始 Docker 文档，保留供参考；本交接项目的实际仿真请优先使用仓库根目录 README 和 `docker/compose.sim.yml`，镜像为 `ghcr.io/ros-industrial-consortium/snp_automate_2023:jazzy-master`。

# SNP Automate 2023 Docker
